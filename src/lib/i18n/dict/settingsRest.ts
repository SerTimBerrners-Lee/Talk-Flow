export const settingsRest = {
  ...
  "mainTab.audioProgress": { ru: "Позиция аудио", en: "Audio position" },
  "mainTab.audioLoadFailed": { ru: "Ошибка", en: "Error" },
  ...
  "settingsApp.tab.interpreter": { ru: "Переводчик", en: "Translator" },
  "settingsApp.tab.chat": { ru: "Чат", en: "Chat" },
