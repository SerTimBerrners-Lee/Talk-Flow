...
- `talkis-stt`: единый OpenAI-совместимый `transcribe.cpp` runtime для Whisper, GigaAM, Qwen ASR и NVIDIA Parakeet; базовый endpoint `http://127.0.0.1:8000`.
...
завершения Talkis восстанавливает доступное аудио и последнюю сохранённую версию
текста.
